...
namespace DKGame
{
    public class DKBalloon : IItem
    {
        ...
        public DKBalloon()
        {
            ...
            state = new DKBalloonIdleState(this);
            BodyDefinition bodyDef = new BodyDefinition() { BottomCenter = new Vector2(150, 150), Dimensions = sprite.Dimensions, Type = BodyType.Kinematic };
