...
namespace DKGame
{
    public class DKBanana : IItem
    {
        ...
        public DKBanana()
        {
            sprite = ItemSpriteFactory.Instance.CreateDKBananaSprite();
            state = new DKBananaIdleState(this);
            BodyDefinition bodyDef = new BodyDefinition() { BottomCenter = new Vector2(375, 150), Dimensions = sprite.Dimensions, Type = BodyType.Kinematic };
