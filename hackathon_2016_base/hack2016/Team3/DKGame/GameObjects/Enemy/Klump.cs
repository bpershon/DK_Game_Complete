...
namespace DKGame
{
    public class Klump : IEnemy
    {
        ...
        public Klump()
        {
            sprite = EnemySpriteFactory.Instance.CreateDKKlumpSprite();
            BodyDefinition bodyDef = new BodyDefinition() { BottomCenter = new Vector2(275, 300), Type = BodyType.Dynamic, Dimensions = sprite.Dimensions };
        ...
        private void OnContact(object sender, ContactEventArgs e)
        {
            ...
            bool obj1IsEnemyNoPlayer = e.Object1.UserData is Klump && !(e.Object2.UserData is Player || e.Object2.UserData is LevelBlock);
            bool obj2IsEnemyNoPlayer = !(e.Object1.UserData is Player || e.Object1.UserData is LevelBlock) && e.Object2.UserData is Klump;
        ...
        public void Kill()
        {
            ...
            SoundPool.PlaySound(Sound.EnemyKlumpDie);
