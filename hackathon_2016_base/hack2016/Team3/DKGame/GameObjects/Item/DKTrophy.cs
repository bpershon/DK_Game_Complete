...
namespace DKGame
{
    public class DKTrophy : IItem
    {
        ...
        public DKTrophy()
        {
            sprite = ItemSpriteFactory.Instance.CreateDKTrophySprite();
            state = new DKTrophyIdleState(this);
            BodyDefinition bodyDef = new BodyDefinition() { BottomCenter = new Vector2(500, 150), Dimensions = sprite.Dimensions, Type = BodyType.Kinematic };
